...
export function StudyChatSidebar({ noteId, contextContent, onProposal, aiMode = "THINKING" }: StudyChatSidebarProps) {
  ...
  const handleSend = async () => {
    ...
    try {
      const { studiesService } = await import("@/lib/api/services/studies.service")
  ...
  return (
    <div className="flex flex-col h-full border-l border-border bg-muted/10 w-full">
