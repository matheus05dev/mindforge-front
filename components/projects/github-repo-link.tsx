...
import { githubService, type GitHubRepoLinkRequest } from "@/lib/api/services/github.service"
...
export function GitHubRepoLink({ projectId, currentRepoUrl, onSuccess, trigger }: GitHubRepoLinkProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true)
    try {
      const data: GitHubRepoLinkRequest = { repoUrl: repoUrl.trim() }
      await githubService.linkRepository(projectId, data)
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Conecte um repositório do GitHub para habilitar code review com IA
            </DialogDescription>
          </DialogHeader>
